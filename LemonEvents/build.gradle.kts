...
tasks {
    shadowJar {
        ...
        relocate("com.zaxxer.hikari", "com.lemonpvp.lemonevents.libs.hikari")
        relocate("com.mysql", "com.lemonpvp.lemonevents.libs.mysql")
        relocate("com.google.protobuf", "com.lemonpvp.lemonevents.libs.protobuf")
    }
