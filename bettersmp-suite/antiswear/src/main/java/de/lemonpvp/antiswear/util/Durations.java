 ...
 * Gleiche Schreibweise wie ueberall in der Suite (siehe BetterSMPs eigene
 * util/Durations.java) - bewusst noch einmal hier dupliziert statt einer
 * gemeinsamen Abhaengigkeit, wie es diese Suite durchgaengig so haelt.
 */
public final class Durations {
    ...
    /** @return Dauer in Millisekunden, oder 0 für permanent/nicht erkannt. */
