 ...
 *
 * Dieselbe Schreibweise wie bei BetterSMPs eigenem /gban (siehe dessen
 * util/Durations.java) - bewusst noch einmal hier und nicht als
 * gemeinsame Abhaengigkeit: Der Proxy ist ein Velocity-Plugin in einem
 * eigenen Modul mit eigenem Classloader, BetterSMP ein Paper-Plugin.
 * Ein gemeinsames drittes Modul nur fuer zwoelf Zeilen waere mehr
 * Umstand als die Dopplung selbst.
 */
